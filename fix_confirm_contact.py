...
def fix_confirm(filepath):
    ...
    content = content.replace("backgroundColor: isDark ? '#2E2E32' : '#22252A'", "backgroundColor: isDark ? colors.white : '#22252A'")
...
fix_confirm('/Users/wrathcodetechnology/Desktop/Projects/AGCE/src/screens/Security/EmergencyContact/ConfirmEmergencyContact.jsx')
