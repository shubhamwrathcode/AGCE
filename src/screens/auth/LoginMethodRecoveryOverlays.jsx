      ...
      <View style={[styles.sheetInner, { paddingBottom: bottomPad }]}>
              ...
              return (
                <TouchableOpacityView
                  ...
                  style={[
                    styles.row,
                    {
                      borderColor: selected ? colors.orangeTheme : border,
                ...
                >
                  <View style={[styles.iconWrap, { backgroundColor: isDark ? "rgba(255,255,255,0.06)" : "#F3F4F6" }]}>
                    <FastImage source={methodIcon(key)} style={{ width: 22, height: 22 }} tintColor={colors.orangeTheme} resizeMode="contain" />
                  </View>
                  ...
                  <View style={[styles.radio, { borderColor: selected ? colors.orangeTheme : border, backgroundColor: selected ? colors.orangeTheme : "transparent" }]}>
        ...
        {step === "warn" ? (
          <>
            ...
            <TouchableOpacityView onPress={() => onResetAck?.(!resetAck)} style={styles.ackRow}>
              <View style={[styles.checkBox, { borderColor: resetAck ? colors.orangeTheme : border, backgroundColor: resetAck ? colors.orangeTheme : "transparent" }]}>
        ...
        {step === "requirements" ? (
          <>
            ...
            <AppText type={TWELVE} weight={SEMI_BOLD} style={{ color: colors.orangeTheme, marginBottom: 10 }}>
              {reqDone} / {reqTotal || 1}
            </AppText>
